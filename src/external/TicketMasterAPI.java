...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "r95tBlwfTHpphslyreg2mmoeq9F10Gac";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		// Use GeoHash instead of Latitude and Longitude
		String geoHash = GeoHash.encodeGeohash(lat, lon, 8);

		//"apikey=qqPuP6n3ivMUoT9fPgLepkRMreBcbrjV&latlong=37,-120&keyword=event&radius=50"
		// String query = String.format("apikey=%s&latlong=%s,%s&keyword=%s&radius=%s&sort=%s&size=%s", API_KEY, lat, lon, keyword, 50, "distance,asc", 50);
		
		// apikey=abcde&geoPoint=xyz123&keyword=&radius=50
		String query = String.format("apikey=%s&geoPoint=%s&keyword=%s&radius=%s&sort=%s&size=%s", API_KEY, geoHash, keyword, 50, "distance,asc", 50);
